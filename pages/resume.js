                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} transition={{ duration: 0.5 }}>
                        <div className="text-center">
                            <h1 className="md:text-6xl text-3xl font-bold">
                                IStayThatWay's <span className="text-rose-500">Resume</span>
                            </h1>
                        ...
                        <div className="relative w-11/12 mx-auto overflow-auto">
                            ...
                            <div className="w-full grid gap-20 grid-cols-1 md:grid-cols-2 blur md:p-16 p-4">
                                ...
                                <div className="flex-grow space-y-2">
                                        <h1 className="text-3xl font-bold">RiftMC • Moderator</h1>
                                        <p className="text-gray-400 py- text-justify">
                                            I used to be a staff member at RiftMC, a server that has an awesome community and an amazing skyblock server that I used to moderate on. I helped anyone in need and it was so much fun, I retired because I had things I had to deal with at the time. 
                                        </p>
